...
build-prompt() {
    ...
    PS1="\[\033]0;$(basename "$(pwd)")$TITLE_AUTH\007\]$(color-dark-grey "\A")$PROMPT_AUTH $(color-blue "\w")$(color-dark-grey " $") $(color-reset)"
...
build-prompt-git() {
    ...
    PS1="\[\033]0;$repo$TITLE_AUTH\007\]$(color-dark-grey "\A")$PROMPT_AUTH $(color-magenta "$repo") $rev$subdir$status_string$(color-dark-grey " $") $(color-reset)"
